...
class Traitement:
    ...
    @classmethod
    def traiterDataExportPVD(cls, data: dict):
        ...
        for unePcResult in onresultPC:
            # Dans le cas où il n'y avait pas d'affichage de résultat (fait main), on ne peut pas retrouver les votes
            # En effet, l'indexation était incrémenté et donc ces votes la sont présent dans les logs mais à fouiller
            # Du coup on les marques pour garder trace
